...
// ==========================================
// SYSTEM INITIALIZATION & AUTO-HEAL
// (Runs once on server start to avoid DB locking during API calls)
// ==========================================
(async () => {
  try {
    console.log("Initializing Database & Auto-healing...");
    // User & OTP extensions
    await pool.query(
    ...
    console.log("Database Auto-healing completed successfully.");
  } catch (err) {
    console.error("Database Auto-healing Error:", err.message);
  }
})();
